...
from .config import DATA_ROOT, TRAIN_JSONL, RUNS_DIR, QDRANT_URL, QDRANT_API_KEY
...
def run_reindex(
    train_file: str = "train_clean.jsonl",
    lane1: bool = False,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train-file", default="train_clean.jsonl",
                        help="Training data file (default: train_clean.jsonl)")
