...
class BiomedCLIPEncoder:
    ...
    def __init__(self, device: str = None):
        ...
        # Patch for transformers >= 5.0 where batch_encode_plus is removed
        if hasattr(self.tokenizer, "tokenizer") and not hasattr(self.tokenizer.tokenizer, "batch_encode_plus"):
            self.tokenizer.tokenizer.batch_encode_plus = self.tokenizer.tokenizer.__call__
