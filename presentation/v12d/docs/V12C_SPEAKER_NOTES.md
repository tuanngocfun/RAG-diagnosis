...
18. **Label-conflict stress test**
    The verified reference label is Non-Leishmaniasis, but the pseudolabel is
    CL and the full-text image/text case is leishmaniasis-plausible. Use this
    to show label conflict and evidence-attribution risk, not specificity
    proof.
19. **Close**
